...
//
// V2o: ordered (o) - simple ordering heuristic (of greedy algorithm)
//      simple bulk pruning (2)
...
//          immediately.
//
// compile: javac -cp .. NumPartV2o.java
// run:     java -cp .. numpart.NumPartV2o PROBLEM_FILE [OPTIONS]
...
public class NumPartV2o extends OptInstance<NumPartV2o.Node, Long>
{
  ...
  private NumPartV2o(Node root, Generator<Node> gen0) {
    super(root, gen0);
    this.np = root.np;
  }

  // instance factory; returns null if np is null.
  public static NumPartV2o mkNumPart(NumPartInstance np) {
    if (np == null)
      return null;
    ...
    // return new instance
    return new NumPartV2o(root, gen0);
  }
