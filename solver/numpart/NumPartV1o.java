...
//
// V1o: ordered (o) - simple ordering heuristic (of greedy algorithm)
//      simple pruning (1)
//      NB: This version essentially implements the Complete Greedy Algorithm
//
// compile: javac -cp .. NumPartV1o.java
// run:     java -cp .. numpart.NumPartV1o PROBLEM_FILE [OPTIONS]
...
public class NumPartV1o extends OptInstance<NumPartV1o.Node, Long>
{
  ...
  private NumPartV1o(Node root, Generator<Node> gen0) {
    super(root, gen0);
    this.np = root.np;
  }

  // instance factory; returns null if np is null.
  public static NumPartV1o mkNumPart(NumPartInstance np) {
    if (np == null)
      return null;
    ...
    // return new instance
    return new NumPartV1o(root, gen0);
  }
