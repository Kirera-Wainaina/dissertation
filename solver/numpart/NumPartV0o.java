...
//
// V0o: ordered (o) - simple ordering heuristic (of greedy algorithm)
//      no pruning (0)
//
// compile: javac -cp .. NumPartV0o.java
// run:     java -cp .. numpart.NumPartV0o PROBLEM_FILE [OPTIONS]
...
public class NumPartV0o extends OptInstance<NumPartV0o.Node, Long>
{
  ...
  private NumPartV0o(Node root, Generator<Node> gen0) {
    super(root, gen0);
    this.np = root.np;
  }

  // instance factory; returns null if np is null.
  public static NumPartV0o mkNumPart(NumPartInstance np) {
    if (np == null)
      return null;
    ...
    // return new instance
    return new NumPartV0o(root, gen0);
  }
